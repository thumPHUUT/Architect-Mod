...
namespace ArchitectMod.Modules
{
    internal static class Skills
    {
        ...
        //for extraskillslots. From NoctisMod. Plural skilldef adders exist aswell

        //this adds skillfamily to body prefab
        internal static void CreateFirstExtraSkillFamily(GameObject targetPrefab)
        {
            ExtraSkillLocator extraSkillLocator = targetPrefab.GetComponent<ExtraSkillLocator>();
            
            bool flag = !extraSkillLocator;
            if (flag)
            {
                extraSkillLocator = targetPrefab.AddComponent<ExtraSkillLocator>();
            }
            extraSkillLocator.extraFirst = targetPrefab.AddComponent<GenericSkill>();
            SkillFamily skillFamily = ScriptableObject.CreateInstance<SkillFamily>();
            skillFamily.variants = new SkillFamily.Variant[0];
            extraSkillLocator.extraFirst._skillFamily = skillFamily;
            
        }
        //this adds activateable skilldef to the skillfamily we just added
        internal static void AddFirstExtraSkill(GameObject targetPrefab, SkillDef skillDef)
        {
            ...
            if (flag)
            {
                SkillFamily skillFamily = component.extraFirst.skillFamily;
        ...
        public static T CreateSkillDef<T>(SkillDefInfo skillDefInfo) where T : SkillDef
        {
            ...
            ArchitectMod.Modules.Content.AddSkillDef(skillDef);
